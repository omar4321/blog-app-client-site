...
function UpdateView(props) {   
  ...
  return <Box className={classes.container}style={{marginTop:"50px"}}>
   ...
   <FormControl className={classes.title}>
                ...
                />
                <InputBase name='title' placeholder="Title" onChange={(e) => handleChange(e)} value={post.title} className={classes.textfield} />
